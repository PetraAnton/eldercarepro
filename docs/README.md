...
> [!TIP]
> **Tìm kiếm nhanh:** Sử dụng Ctrl+F trong VS Code để tìm kiếm trong tất cả file markdown

> [!IMPORTANT]
> **Luôn cập nhật:** Khi code thay đổi, nhớ cập nhật tài liệu tương ứng

> [!NOTE]
> **Backup:** Tài liệu được lưu trong Git, nhớ commit thường xuyên
